...
namespace WindowsFormsContacts
{
    public partial class Form1 : Form
    {
        ...
        {
            //obtenemos los datos
            List<Contact> contacts = _bussinessLogicLayer.GetAllContacts();
        ...
        {
            //capturamos la celda pinchada, y aseguramos que sea el link edit
            DataGridViewLinkCell cell = (DataGridViewLinkCell)dataGridView1.
